...
Previous analyses of these data included examining insect flux across terrestrial and wetland habitats (1, 2, 3). Insects were captured in malaise traps, which are tent like structures that capture insects that fly into them, and crawl upwards to escape, only to fall into bottles to be collected.
